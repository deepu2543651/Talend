...
package test_project.shadowfileinputtodelimitedoutput_0_1;
...
public class ShadowFileInputToDelimitedOutput implements TalendJob {
	...
	public static class RowStruct implements
		...
		final static byte[] commonByteArrayLock_TEST_PROJECT_ShadowFileInputToDelimitedOutput = new byte[0];
		static byte[] commonByteArray_TEST_PROJECT_ShadowFileInputToDelimitedOutput = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TEST_PROJECT_ShadowFileInputToDelimitedOutput.length) {
					if (length < 1024
							&& commonByteArray_TEST_PROJECT_ShadowFileInputToDelimitedOutput.length == 0) {
						commonByteArray_TEST_PROJECT_ShadowFileInputToDelimitedOutput = new byte[1024];
					} else {
						commonByteArray_TEST_PROJECT_ShadowFileInputToDelimitedOutput = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_TEST_PROJECT_ShadowFileInputToDelimitedOutput,
						0, length);
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TEST_PROJECT_ShadowFileInputToDelimitedOutput) {
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				fileName_tFileOutputDelimited = (new java.io.File(
						"D:/TOS_DI-20151214_1327-V6.1.1/TOS_DI-20151214_1327-V6.1.1/workspace/TEST_PROJECT/temp/preview/52WeeksHigh2-14-2017.csv"))
				...
				try {
					...
					Object filename_tFileInputDelimited = "D:/TOS_DI-20151214_1327-V6.1.1/52WeeksHigh2-14-2017.csv";
					...
					while (fid_tFileInputDelimited != null
						...
						try {
							...
							Row.row7 = fid_tFileInputDelimited
									.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 8;

							Row.row8 = fid_tFileInputDelimited
									.get(columnIndexWithD_tFileInputDelimited);
		...
		try {
			...
			java.io.InputStream inContext = ShadowFileInputToDelimitedOutput.class
					.getClassLoader().getResourceAsStream(
							"test_project/shadowfileinputtodelimitedoutput_0_1/contexts/"
...
/************************************************************************************************
 * 41639 characters generated by Talend Open Studio for Data Integration on the
 * February 14, 2017 7:52:07 PM IST
 ************************************************************************************************/
